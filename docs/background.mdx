...
That lazy-hydration shows through in the API: values come back typed and parsed, resolved only when
awaited — including fields nested inside semantic nodegroups. This runs live in your browser (press ▶):
