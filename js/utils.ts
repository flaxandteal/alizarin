...
// TODO: a nicer way of unifying these
function getValueFromPathSync(asset: any, path: string): any {
  let segments = path.split(".");
  function get(value: any, key: string): any {
    if (key !== "_" && Array.isArray(value)) {
      const results: any[] = value;
  ...
  function descend(headValue: any, segments: string[]) {
...
async function getValueFromPath(asset: any, path: string): Promise<any> {
  let segments = path.split(".");
