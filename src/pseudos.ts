...
class PseudoValue implements IPseudo {
  ...
  async getTile() {
    ...
    let tile = this.node.is_collector ? this.tile : null;
...
// Fix wkri type.
function makePseudoCls(this: IModelWrapper, key: string, single: boolean, tile: StaticTile | null=null, wkri: any | null=null): PseudoList | PseudoValue | PseudoUnavailable {
